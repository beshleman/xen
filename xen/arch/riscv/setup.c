...
/* PRE-RFC: remove all of this before RFC'ing 
...
#define XEN_OFFSET     (12 << 20)
   ...
   /*
    * TODO: Do not hardcode this.  There has been discussion on how OpenSBI will be 
...
/*
 * TODO: Figure out how PDX works and actually support it for RISC-V.
 *
 * Currently, this results in zero compression and works for now.
 */
